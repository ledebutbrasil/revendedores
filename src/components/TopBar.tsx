...
export const TopBar: React.FC = () => {
  return (
    <div className="bg-pink text-white py-2 overflow-hidden whitespace-nowrap relative z-40 text-[11px] sm:text-xs font-semibold uppercase tracking-widest select-none border-b border-white/5">
